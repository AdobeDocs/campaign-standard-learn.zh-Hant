...
# Android™應用程式推播通知快速入門

Adobe Campaign可讓您將個人化和分段的推播通知傳送至iOS和Android™行動裝置。
這些訊息會在您使用Experience Cloud行動SDK V4或Experience PlatformSDK在Adobe Campaign中設定的行動應用程式上接收。
...
* 您應該已透過 Adobe Campaign Standard 延伸功能設定啟動屬性。請按照以下線上說明操作。
   ...
   * [文件](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/mobile/configure-mobile-apps-using-aep-sdk.html?lang=en)
...
* [步驟1 — 建立Android™應用程式](/help/tutorial-push-notifications-android/create-android-app.md)
