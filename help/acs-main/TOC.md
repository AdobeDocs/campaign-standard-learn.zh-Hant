...
+ [Adobe Campaign Standard 教學課程](/help/overview.md)
...
+ 輪廓與客群 {#profiles-and-audiences}
   + [建立輪廓和客群 - 概觀](/help/profiles-and-audiences/creating-profiles-and-audiences.md)
   + [建立輪廓](/help/profiles-and-audiences/creating-a-profile.md)
...
+ 通訊管道 {#communication-channels}
   + 電子郵件 {#email}
      ...
      + [使用目標輪廓測試電子郵件訊息](/help/communication-channels/email/profile-substitution.md)
   ...
   + 行動 {#mobile}
      ...
      + 應用程式內訊息 {#in-app}
         ...
         + [根據其 Campaign 輪廓鎖定使用者](/help/communication-channels/mobile/in-app/target-users-based-on-campaign-profile.md)
